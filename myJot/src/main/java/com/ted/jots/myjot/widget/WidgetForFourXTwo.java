 ...
 */
public class WidgetForFourXTwo extends AppWidgetProvider {

    @Override
    public void onReceive(Context context, Intent intent) {
        super.onReceive(context, intent);
        if (null == intent.getAction() || !intent.getAction().equalsIgnoreCase("android.appwidget.action.APPWIDGET_SET_DATA"))
            return;
        ComponentName componentName = new ComponentName(context, WidgetForFourXTwo.class);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        int[] widgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, WidgetForFourXTwo.class));
